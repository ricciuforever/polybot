...
class AzuroTrader:
    ...
    def execute_bet(self, condition_id, outcome_id, amount_human, min_odds_decimal):
        ...
        try:
            ...
            # (Per semplicità qui controlliamo e avvisiamo. In una versione più avanzata faremmo approve automatica)
            # Ma il task chiede l'esecuzione, quindi facciamo l'approve se necessario.
            
            # ... (Logica di approve omessa per concisione se già fatta, ma aggiungiamola per sicurezza)
